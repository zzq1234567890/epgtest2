...
$tru19=count($piec19);
  ...
  $chn.= "".str_replace('【好劇LIVE24h爆肝直播】','',str_replace('Live!','',str_replace('LIVE:','',str_replace('正在直播:','',str_replace('【LIVE】','',str_replace('【ON AIR】','', $piek19[$k19][1])))))).",http://zzqwe.giize.com:12229/fengzhibo.php?id=".$piec19[$k19][1]."\r\n";
}
...
$chn.= "".$pieq[$k][1]."".$piek[$k][1].",http://zzqwe.giize.com:12229/huyalive.php?id=".$piec[$k][1]."\r\n";
}
...
//echo "正在播放".$piek[$k][1].",http://zzqwe.giize.com:12229/huyalive.php?v=".$piec[$k][1]."<br>";
$chn.=t "".$pieq1[$k1][1]."".$piek1[$k1][1].",http://zzqwe.giize.com:12229/huyalive.php?id=".$piec1[$k1][1]."\r\n";
}
