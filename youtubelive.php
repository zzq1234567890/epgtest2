...
print "".str_replace('【好劇LIVE24h爆肝直播】','',str_replace('Live!','',str_replace('LIVE:','',str_replace('正在直播:','',str_replace('【LIVE】','',str_replace('【ON AIR】','', $piek2[$k2][1])))))).",http://zzqwe.giize.com:12229/youtube.php?v=".$piec2[$k2][1]."\r\n";
}
...
print "".str_replace('【好劇LIVE24h爆肝直播】','',str_replace('Live!','',str_replace('LIVE:','',str_replace('正在直播:','',str_replace('【LIVE】','',str_replace('【ON AIR】','', $piek3[$k3][1])))))).",http://zzqwe.giize.com:12229/youtube.php?v=".$piec3[$k3][1]."\r\n";
}
print "正在直播,#genre#\r\n";
...
print "".str_replace('【好劇LIVE24h爆肝直播】','',str_replace('Live!','',str_replace('LIVE:','',str_replace('正在直播:','',str_replace('【LIVE】','',str_replace('【ON AIR】','', $piek4[$k4][1])))))).",http://zzqwe.giize.com:12229/youtube.php?v=".$piec4[$k4][1]."\r\n";
}
...
print "".str_replace('【好劇LIVE24h爆肝直播】','',str_replace('Live!','',str_replace('LIVE:','',str_replace('正在直播:','',str_replace('【LIVE】','',str_replace('【ON AIR】','', $piek5[$k5][1])))))).",http://zzqwe.giize.com:12229/youtube.php?v=".$piec5[$k5][1]."\r\n";
}
...
print "".str_replace('【好劇LIVE24h爆肝直播】','',str_replace('Live!','',str_replace('LIVE:','',str_replace('正在直播:','',str_replace('【LIVE】','',str_replace('【ON AIR】','', $piek6[$k6][1])))))).",http://zzqwe.giize.com:12229/youtube.php?v=".$piec6[$k6][1]."\r\n";
}
...
print "".str_replace('【好劇LIVE24h爆肝直播】','',str_replace('Live!','',str_replace('LIVE:','',str_replace('正在直播:','',str_replace('【LIVE】','',str_replace('【ON AIR】','', $piek8[$k8][1])))))).",http://zzqwe.giize.com:12229/youtube.php?v=".$piec8[$k8][1]."\r\n";
}
print "國外新聞,#genre#\r\n";
...
print "".str_replace('【好劇LIVE24h爆肝直播】','',str_replace('Live!','',str_replace('LIVE:','',str_replace('正在直播:','',str_replace('【LIVE】','',str_replace('【ON AIR】','', $piek9[$k9][1])))))).",http://zzqwe.giize.com:12229/youtube.php?v=".$piec9[$k9][1]."\r\n";
}
...
print "".str_replace('【好劇LIVE24h爆肝直播】','',str_replace('Live!','',str_replace('LIVE:','',str_replace('正在直播:','',str_replace('【LIVE】','',str_replace('【ON AIR】','', $piek7[$k7][1])))))).",http://zzqwe.giize.com:12229/youtube.php?v=".$piec7[$k7][1]."\r\n";
}
...
print "".str_replace('【好劇LIVE24h爆肝直播】','',str_replace('Live!','',str_replace('LIVE:','',str_replace('正在直播:','',str_replace('【LIVE】','',str_replace('【ON AIR】','', $piek10[$k10][1])))))).",http://zzqwe.giize.com:12229/youtube.php?v=".$piec10[$k10][1]."\r\n";
}
...
print "".str_replace('【好劇LIVE24h爆肝直播】','',str_replace('Live!','',str_replace('LIVE:','',str_replace('正在直播:','',str_replace('【LIVE】','',str_replace('【ON AIR】','', $piek12[$k12][1])))))).",http://zzqwe.giize.com:12229/youtube.php?v=".$piec12[$k12][1]."\r\n";
}
...
print "".str_replace('【好劇LIVE24h爆肝直播】','',str_replace('Live!','',str_replace('LIVE:','',str_replace('正在直播:','',str_replace('【LIVE】','',str_replace('【ON AIR】','', $piek8[$k8][1])))))).",http://zzqwe.giize.com:12229/fengzhibo.php?id=".$piec8[$k8][1]."\r\n";
}


$url19='https://console.zhibo.ifeng.com/web/live/notice?date='.$dt11;
/*
$headers19=[

'Host: console.zhibo.ifeng.com',
'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:99.0) Gecko/20100101 Firefox/99.0',
'Referer: https://flive.ifeng.com/',
'Platform: pc',
'Uuid: B158572441A44D6EB97ED9595D91B300',
'Origin: https://flive.ifeng.com',
'DNT: 1',
];
*/
...
curl_setopt($ch19,CURLOPT_USERAGENT,'Mozilla/5.0');
$re19=curl_exec($ch19);
curl_close($ch19);


preg_match_all('|\{"liveId":(.*?),"title|i',$re19,$piec19,PREG_SET_ORDER);//節目id
preg_match_all('|\,"title":"(.*?)","state"\:1,"thumb|i',$re19,$piek19,PREG_SET_ORDER);//節目標題
$tru19=count($piec19);
  for ($k19 = 0; $k19 <=$tru19-1; $k19++) {

print "".str_replace('【好劇LIVE24h爆肝直播】','',str_replace('Live!','',str_replace('LIVE:','',str_replace('正在直播:','',str_replace('【LIVE】','',str_replace('【ON AIR】','', $piek19[$k19][1])))))).",http://zzqwe.giize.com:12229/fengzhibo.php?id=".$piec19[$k19][1]."\r\n";
}


/*
$urlk='https://console.zhibo.ifeng.com/web/live/channel?page=1&id=68&state=1';
...
$liveId=json_decode($rek)->data->list[$_GET['id']-1]->liveId;
print "虎牙直播,#genre#\r\n";
$url='https://www.huya.com/l';//youtube正在播放
$ch=curl_init();
...
$re = preg_replace_callback('/\\\\u([0-9a-f]{4})/i', 'replace_unicode_escape_sequence', $re);// 適合php7
//print $re;

preg_match_all('|"privateHost":"(.*?)",|i',$re,$piec,PREG_SET_ORDER);//vid
preg_match_all('|"gameFullName":"(.*?)",|i',$re,$pieq,PREG_SET_ORDER);//遊戲名稱
preg_match_all('|<i class="nick" title="(.*?)">|i',$re,$piek,PREG_SET_ORDER);//遊戲名稱

$tru=count($piec);
  for ($k = 0; $k <=$tru-1; $k++) {

//echo "正在播放".$piek[$k][1].",http://zzqwe.giize.com:12229/huyalive.php?v=".$piec[$k][1]."<br>";
print "".$pieq[$k][1]."".$piek[$k][1].",http://zzqwe.giize.com:12229/huyalive.php?id=".$piec[$k][1]."\r\n";
}


//for ($m=1;$m<=210;$m++){
for ($m=1;$m<=200;$m++){
$url1='https://www.huya.com/cache.php?m=LiveList&do=getLiveListByPage&tagAll=0&callback=getLiveListJsonpCallback&page='.$m;
$ch1=curl_init();
...
$re1=curl_exec($ch1);
curl_close($ch1);
$re1 = preg_replace_callback('/\\\\u([0-9a-f]{4})/i', 'replace_unicode_escape_sequence', $re1);// 適合php7

preg_match_all('|"privateHost":"(.*?)",|i',$re1,$piec1,PREG_SET_ORDER);//vid
preg_match_all('|"nick":"(.*?)",|i',$re1,$pieq1,PREG_SET_ORDER);//遊戲名稱
preg_match_all('|"roomName":"(.*?)",|i',$re1,$piek1,PREG_SET_ORDER);//遊戲名稱

$tru1=count($piec1);
  for ($k1 = 0; $k1 <=$tru1-1; $k1++) {
//echo "正在播放".$piek[$k][1].",http://zzqwe.giize.com:12229/huyalive.php?v=".$piec[$k][1]."<br>";
print "".$pieq1[$k1][1]."".$piek1[$k1][1].",http://zzqwe.giize.com:12229/huyalive.php?id=".$piec1[$k1][1]."\r\n";
}
